<template>
    <div class="w-96 mx-auto">
        ...
        <div class="mb-4">
            <div class="mb-3">
                <input v-model="title" class="w-96 rounded-3xl border p-2 border-gray-400" type="text" placeholder="title">
            </div>
            <div v-if="errors.title">
                <p v-for="error in errors.title" class="text-sm text-red-500">{{ error }}</p>
            </div>
            <div class="mb-3">
                <textarea v-model="content" class="w-96 rounded-3xl border p-2 border-gray-400" type="text" placeholder="content"></textarea>
            ...
            <div class="flex mb-3 items-center">
                <div>
                    ...
                    <a href="#" class="block p-2 w-16 text-sm rounded-3xl bg-sky-500 text-white" @click.prevent="selectFile()">Image</a>
                </div>
                <div>
            ...
            <div>
                <a @click.prevent="store" href="#" class="block p-2 w-32 text-center rounded-3xl bg-green-500 text-white
                hover:bg-white
                hover:border
