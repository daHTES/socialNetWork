...
use function Symfony\Component\HttpFoundation\closeOutputBuffers;
...
class UserController extends Controller
{
    public function index(){
        ...
        $followingIds = SubscribeFollowing::where('subscriber_id', auth()->id())
    ...
    public function stat(StatRequest $request){
            ...
            $result = [];
            $result['subscribers_count'] = SubscribeFollowing::where('following_id', $userId)->count();
            $result['followings_count'] = SubscribeFollowing::where('subscriber_id', $userId)->count();
